...
namespace Names
{
    internal static class Charts
    {
        public static void ShowHistogram(HistogramData stats)
        {
            ...
            // Примеры можно найти тут https://jenyay.net/Programming/ZedGraph
            // или тут https://web.archive.org/web/20051127161423/http://zedgraph.sourceforge.net/samples.html
